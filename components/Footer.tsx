...
import { CONTACT_INFO, SOCIAL_MEDIA_LINKS } from '@/lib/constants'
    ...
    <footer className="bg-brand-600 border-t border-brand-700">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-8">
          <Link href="/" className="inline-flex items-center mb-4" aria-label="LegalEase home">
            <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            ...
            {Object.values(SOCIAL_MEDIA_LINKS).every(link => !link) && (
              <p className="text-xs text-white/60 mt-2" role="status">
        ...
        <div className="pt-8 border-t border-white/20 text-center text-sm text-white/70">
          ...
          <p className="mt-2 text-xs">
            ...
            Nigerian lawyers. No AI is used for legal advice or contract review.
          </p>
        </div>
      </div>
    </footer>
